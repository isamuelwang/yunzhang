...
public class QiNiuUtil {
    ...
    private static final String accessKey = "ZwbSWk8nWYwwDBEKot1B_5bexyDn-QT0JUtCSwu9";
    private static final  String secretKey = "MDZI8-T-ftzdZU4O09wnoKEGI57H9tHyTdl3FLwd";

    public static void main(String[] args) throws Exception {
        File file = new File("C:\\Users\\zhangrw\\Desktop\\page\\bae.gif");

        String bucketNm = "yellowcong";
        //通过文件来传递
...
//      delete(bucketNm, "fdafaf.gif");
     ...
     * @return
     */
    public static QiNiuResult upload(String bucketNm,InputStream in,String key) {
        ...
        try {
            ...
            result = new QiNiuResult(true,putRet.key);
        }catch (Exception e) {
            result = new QiNiuResult(false);
        }
        return result;
    }
    /**
     ...
     * @return
     */
    public static QiNiuResult upload(String bucketNm,File file) {
        QiNiuResult result = null;
        try {
